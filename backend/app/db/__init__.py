...
from app.models import email_log, news, user  # noqa: F401 - imported for metadata registration
from app.models.database import Base, close_engine, get_db_session, get_engine, init_engine
